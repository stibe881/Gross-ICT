...
export function ManusDialog({
  ...
  return (
    ...
    >
      <DialogContent className="py-5 bg-card rounded-[20px] w-[400px] shadow-xl border border-border backdrop-blur-2xl p-0 gap-0 text-center">
        <div className="flex flex-col items-center gap-2 p-5 pt-12">
          {logo ? (
            <div className="w-16 h-16 bg-background rounded-xl border border-border flex items-center justify-center">
              <img src={logo} alt="Dialog graphic" loading="lazy" decoding="async" className="w-10 h-10 rounded-md" />
            </div>
          ) : null}
