  ...
  return (
    <div className="absolute inset-0 -z-10 h-full w-full">
      <Canvas gl={{ antialias: false }} dpr={[1, 1]}>
        ...
        <pointLight position={[10, 10, 10]} intensity={3} color="#FAC863" />
        ...
        <ScrollRig>
          <group position={[0, 0, 0]}>
            ...
            <ModernShape position={[3, 1, 0]} type="torus" color="#FAC863" scale={1.2} speed={0.8} />

            {/* Floating Crystals */}
            <ModernShape position={[-3, -1, 1]} type="icosa" color="#eee" scale={0.8} speed={0.6} />
            <ModernShape position={[0, 2, -2]} type="octa" color="#ddd" scale={0.6} speed={1.2} />
            <ModernShape position={[-2, 3, -1]} type="icosa" color="#FAC863" scale={0.4} speed={0.4} />
            <ModernShape position={[2, -2, -1]} type="torus" color="#ccc" scale={0.5} speed={0.9} />

            <Sparkles count={30} scale={12} size={3} speed={0.4} opacity={0.4} color="#FAC863" />
          </group>
        </ScrollRig>
